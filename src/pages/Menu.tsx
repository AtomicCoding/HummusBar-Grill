      ...
      <main className="pt-16 lg:pt-20">
        ...
        <section className="py-20 bg-white">
          <div className="container-custom section-padding">
            <h2 className="text-4xl lg:text-5xl font-bold text-center text-foreground uppercase mb-16">
              BREAKFAST MENU
            </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 max-w-6xl mx-auto mb-16">
              ...
              <div className="text-center">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-soft mb-6">
                  <img
