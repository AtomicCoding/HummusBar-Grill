    ...
    <div className="min-h-screen bg-black">
      ...
      <main className="pt-16 lg:pt-20">
        ...
        <section className="py-20 bg-gradient-to-b from-black to-gray-900 relative">
          <div className="absolute inset-0 bg-gradient-to-r from-red-900/10 to-black/50" />
          <div className="relative z-10 container-custom section-padding">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 max-w-6xl mx-auto mb-16">
              ...
              <div className="group text-center">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl mb-6 transition-transform duration-300 group-hover:scale-105">
                  <img
              ...
              {/* Royal Breakfast */}
              <div className="group text-center lg:col-start-2">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl mb-6 transition-transform duration-300 group-hover:scale-105">
                  <img
            ...
            <div className="text-center pt-6">
              <Button
                asChild
                className="bg-red-600 hover:bg-red-700 text-white px-8 py-4 text-lg font-bold rounded-lg shadow-xl hover:shadow-2xl transition-all duration-300"
              >
                <a
        ...
        {/* SECTION 2: LUNCH & DINNER MENU */}
        <section className="py-20 bg-gradient-to-b from-gray-900 to-black relative">
          <div className="absolute inset-0 bg-gradient-to-r from-red-900/20 to-black/70" />
          <div className="relative z-10 container-custom section-padding">
        ...
        {/* SECTION 5: DRINKS */}
        <section className="py-20 bg-gradient-to-b from-black to-gray-900 relative">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-900/20 to-black/70" />
          <div className="relative z-10 container-custom section-padding">
